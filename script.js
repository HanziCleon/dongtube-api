...
class URLRouter {
  ...
  parseWatchURL() {
    ...
    // New format: /watch/anime-title=id:2&ep=1
  ...
  updateURL(anime, episode) {
    ...
    this.updateMetaTags(anime, episode);
  }

  updateMetaTags(anime, episode) {
    const title = `Watch ${anime.title} Episode ${episode} - DongTube`;
    const description = anime.description || `Watch ${anime.title} with HD quality`;
    
    this.setMetaTag('description', description);
    this.setMetaTag('og:title', title);
    this.setMetaTag('og:description', description);
    this.setMetaTag('og:image', anime.thumb);
  }
